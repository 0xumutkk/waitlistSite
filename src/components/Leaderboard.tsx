...
export function Leaderboard({ entries, isLoading, referralLink, onCopyReferral }: LeaderboardProps) {
  ...
  return (
    <div className="w-[370px] h-full bg-white/60 rounded-[12px] p-[12px] flex flex-col justify-between overflow-hidden">
      <div className="w-[346px] flex flex-col rounded-[8px] overflow-hidden border border-black/15 bg-transparent">
        {/* Header */}
        <div className="flex items-center w-full border-b border-black/15">
          ...
          <div className="w-[117px] h-[38px] flex items-center justify-center px-2">
          ...
          {displayEntries.map((entry, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-[117px] h-[56px] flex items-center justify-center px-[8px]">
